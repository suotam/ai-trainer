    ...
    for (final row in instances) {
      planned.add(
        PlannedSyncEntity(
          ...
          localRevision: 'v${row.rowVersion}',
    ...
    for (final session in sessions) {
      planned.add(
        PlannedSyncEntity(
          ...
          localRevision: 'v${session.rowVersion}',
      ...
      for (final step in steps) {
        planned.add(
          PlannedSyncEntity(
            ...
            localRevision: 'v${step.rowVersion}',
            stateEntityType: 'WORKOUT_SESSION',
            stateEntityId: session.id,
          ),
        );
        ...
        for (final set in sets) {
          planned.add(
            PlannedSyncEntity(
              ...
              localRevision: 'v${set.rowVersion}',
              stateEntityType: 'WORKOUT_SESSION',
              stateEntityId: session.id,
            ),
          );
      ...
      for (final feedback in feedbackRows) {
        planned.add(
          PlannedSyncEntity(
            ...
            localRevision: 'u${feedback.updatedAt}',
            stateEntityType: 'WORKOUT_SESSION',
            stateEntityId: session.id,
          ),
        );
    ...
    for (final summary in summaries) {
      planned.add(
        PlannedSyncEntity(
          ...
          localRevision: 'c${summary.createdAt}',
