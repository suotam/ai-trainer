...
`R0-01` až `R0-07` jsou implementovány a R0 exit review je uzavřeno (viz `DOCUMENTATION_STATUS.md` §3). Z R1 je implementován `R1-01`. Dalším kanonickým krokem je implementace:
