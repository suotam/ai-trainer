...
```text
Plánování Release 4 – AI Plan Proposal Slice  (release scope §8)
```

Plánování ani implementace R4 nezačíná bez samostatného pokynu.
